...
| --- | --- | --- | --- | --- | --- | --- |
| E1 | 10/09/2026 | ChatGPT | Diseño del catálogo en forma de lista. Revisión del código y documentación | Agilizar el armado del catálogo a mano.| Verificamos que los campos se hayan copiado correctamente. Adaptación del contenido, edición de los archivos y revisión del proyecto  | Sarmiento, Emanuel Ricardo. Lautaro Altamirano |
| E2 |  |  |  |  |  |  |
| E3 |  |  |  |  |  |  |
| E4 |  |  |  |  |  |  |
| E5 |  |  |  |  |  |  |
