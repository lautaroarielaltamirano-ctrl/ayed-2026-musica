...
| P05 | E2 | Evaluar la función recursiva con una canción no existente (ej:100) | id_cancion = 100 | La función devuelve un mensaje de error claro, el menú sigue |  |  |
| P06 | E2 | Evaluar la función recursiva con valor que no sea int (ej:abc) | id_cancion = abc | La función devuelve un mensaje de error claro, el menú sigue |  |  |
| P07 | E1 | Pasar enter vacío en el menú | id = "" | El menú continúa |  |  |
| P08 | E1 | Elegir una opción de menú inválida (ej. “abc”) | id = "abc" | El menú continúa |  |  |
